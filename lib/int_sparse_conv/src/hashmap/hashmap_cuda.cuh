/*
This file is copied from the project: torchsparse
Original source: https://github.com/mit-han-lab/torchsparse
...
__inline__ __device__ int atomicCAS(int* address, int compare, int val) {
  return ::atomicCAS(address, compare, val);
}

__inline__ __device__ unsigned int atomicCAS(unsigned int* address, unsigned int compare, unsigned int val) {
  return ::atomicCAS(address, compare, val);
}
