...
class Config(SimpleConfig):
    model_path: str = 'models.Hengshuang'  # require model_path.ModelConfig and model_path.PointCompressor exist
    ...
    def __post_init__(self):
        # import needed model config depending on model_path
        try:
